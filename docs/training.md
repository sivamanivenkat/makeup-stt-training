...
- _Why:_ In short instruction clips, differences in commas, periods, or capitalization (e.g. `"Apply foundation"` vs `"apply foundation."`) would artificially inflate WER without representing real transcription errors.
